...
// มิ.ย.2569: เพิ่มคำอวยพรยาวแบบ "พรผู้ใหญ่" (บุญบารมี/รวยทรัพย์/สุขภาพ หลายวรรคต่อเนื่อง)
// ตามสไตล์ภาพสวัสดีไทยที่นิยมส่งต่อกัน — คำสั้นเดิมยังอยู่ครบ สุ่มคละกัน
const CAT_BLESSINGS = {
  flowers: [
    'ขอให้ชีวิตเบ่งบานงดงาม มั่งมีศรีสุข สมหวังดั่งใจ สุขภาพแข็งแรง ตลอดวันตลอดไป',
    'ดอกไม้บานรับวันใหม่ ขอให้โชคลาภไหลมาเทมา พบแต่สิ่งดีงาม จิตใจเบิกบานทุกวัน',
  ...
  dharma: [
    'ขอบุญบารมีคุ้มครองปกป้อง พบแต่สิ่งที่ดีๆ มั่งมีศรีสุข เจริญรุ่งเรือง สำเร็จสมปรารถนา สุขภาพแข็งแรง',
    'ขอสิ่งศักดิ์สิทธิ์คุ้มครอง ให้แคล้วคลาดปลอดภัย คิดสิ่งใดสมปรารถนา ร่มเย็นเป็นสุขทั้งครอบครัว',
    'บุญรักษา เทวดาคุ้มครอง ขอให้ชีวิตพบแต่ความสุขความเจริญ ทุกข์โศกโรคภัยอย่าได้มาแผ้วพาน',
  ...
  inspire: [
    'รวยสุข รวยทรัพย์ รวยความดี มั่งคั่ง มั่งมี สุขภาพแข็งแรง คิดสิ่งใดสมความปรารถนา',
    'ขอให้ร่ำรวยเงินทอง ค้าขายรุ่งเรือง กิจการก้าวหน้า เงินทองไหลมาเทมา ครอบครัวเป็นสุข',
  ...
  miss: [
    'คิดถึงเสมอนะ ขอให้อยู่ดีมีสุข แข็งแรงปลอดภัย พบเจอแต่สิ่งดีๆ ตลอดวัน',
  ...
  birthday: [
    'สุขสันต์วันเกิด ขอให้อายุมั่นขวัญยืน ร่ำรวยเงินทอง สุขภาพแข็งแรง คิดสิ่งใดสมปรารถนาทุกประการ',
  ...
  elderly: [
    'ขอให้สุขภาพแข็งแรง อายุมั่นขวัญยืน ลูกหลานกตัญญู รายล้อมด้วยความรัก อยู่เย็นเป็นสุขตลอดไป',
    'ขอพรอันประเสริฐจงบังเกิดแก่ท่าน ให้แข็งแรงปราศจากโรคภัย จิตใจเบิกบาน มีความสุขทุกคืนวัน',
  ...
  health: [
    'ขอให้สุขภาพแข็งแรง ปราศจากโรคภัย กายใจเป็นสุข อายุมั่นขวัญยืน อยู่กับลูกหลานไปนานๆ',
    'ขอให้แข็งแรงทั้งกายและใจ โรคภัยอย่าได้มาเบียดเบียน มีเรี่ยวแรงทำสิ่งที่รักทุกวัน',
  ...
  festival: [
    'ขอให้เฮงๆ รวยๆ โชคลาภเงินทองไหลมาเทมา สุขภาพแข็งแรง ครอบครัวอบอุ่นเป็นสุข',
  ...
  family: [
    'ขอให้ครอบครัวร่มเย็นเป็นสุข ลูกหลานเจริญก้าวหน้า กิจการงานรุ่งเรือง เงินทองไม่ขาดมือ',
    'ขอให้ทุกคนในบ้านแข็งแรงปลอดภัย รักใคร่กลมเกลียว มีแต่ความสุขความเจริญตลอดไป',
  ...
  pets: [
    'ขอให้คุณและน้องสี่ขาแข็งแรง อยู่ด้วยกันไปนานๆ มีความสุขอบอุ่นใจทุกวัน',
  ...
  coffee: [
    'อรุณสวัสดิ์ยามเช้า ขอให้วันนี้สดใสราบรื่น งานการคล่องตัว เงินทองไหลมา สุขกายสบายใจ',
  ...
  nature: [
    'ขอให้ชีวิตสงบเย็นดั่งสายน้ำ มั่นคงดั่งขุนเขา สดใสดั่งตะวันยามเช้า มีความสุขตลอดวัน',
...
async function genBlessingsGemini({ dayTh, headline, isFestival, n, extraContext }) {
  ...
  + `- คละความยาว 3 แบบ: ~40% "สั้น กระชับ" (3-8 คำ เช่น "โชคดีมีสุข สมปรารถนา"), ~30% ยาวปานกลาง (~20 คำ), ~30% "ยาวแบบพรผู้ใหญ่" หลายวรรคต่อเนื่อง (เช่น "ขอบุญบารมีคุ้มครอง พบแต่สิ่งที่ดีๆ มั่งมีศรีสุข เจริญรุ่งเรือง สำเร็จสมปรารถนา สุขภาพแข็งแรง")\n`
  + `- ไม่ต้องยาวทุกประโยค ประโยคสั้น ๆ ที่ฟังดูเป็นมงคลก็ดีมาก\n`
  + `- ใช้ภาษาไทยที่ไพเราะ อ่านแล้วรู้สึกอบอุ่นใจ\n`
  + `- มีความหลากหลาย ครอบคลุมหลายธีม เช่น: สุขภาพ, ความสุข, โชคลาภเงินทอง, บุญบารมี, ครอบครัว, กำลังใจ, ธรรมะ, ความสำเร็จ, ความรัก\n`
  + (isFestival
  ...
  function parseArr(text) {
    ...
    if (!m) return [];
    try {
      return JSON.parse(m[0]).filter(x => typeof x === 'string').map(x => x.trim())
        .filter(x => validCardText(x, { min: 5, max: 120 }));  // คัดคำเพี้ยน/อักขระแปลกออกตั้งแต่ต้นทาง (120 เผื่อพรผู้ใหญ่แบบยาว)
    } catch { return []; }
  }
...
// ── ตัวกรองคุณภาพข้อความไทยที่จะอบลงการ์ด ───────────────────────────────────
// กันคำเพี้ยน/เรียงประโยคผิดจาก LLM (เช่น "แด่คนวันเกิด") หลุดไปถึงผู้สูงอายุ
// ใช้คู่กับด่าน rubric (appropriateness <= 2 = veto) — กรองที่ต้นทางก่อนถูกที่สุด
const BANNED_TEXT_STARTERS = /^(แด่|แก่|ถึง|สำหรับ|เพื่อ|ของ|โดย|จาก|กับ|ๆ|ฯ)/;
const CARD_TEXT_CHARSET = /^[\u0E00-\u0E7Fa-zA-Z0-9\s.,!?'"()\u2018\u2019\u201C\u201D\-\u2013\u2014\u2026]+$/;
function validCardText(s, { min = 2, max = 24 } = {}) {
  const t = String(s || '').trim();
  if (t.length < min || t.length > max) return false;
  if (!CARD_TEXT_CHARSET.test(t)) return false;     // อักขระแปลก/อิโมจิ/สัญลักษณ์หลุด
  if (BANNED_TEXT_STARTERS.test(t)) return false;   // ขึ้นต้นแบบไม่ใช่คำทักทายไทยธรรมชาติ
  if (/(.)\1{3,}/.test(t)) return false;            // ตัวอักษรเดิมซ้ำรัวผิดปกติ
  return true;
}
// คำหัวหมวดต้องมี keyword ของหมวดจริง (กันคำหลุดธีม)
const CAT_HEADLINE_KEYWORDS = {
  birthday: /วันเกิด|birthday/i,
  miss:     /คิดถึง/,
  inspire:  /กำลังใจ|สู้|ทำได้|ฝัน|ไหว/,
  health:   /สุขภาพ|แข็งแรง|ดูแล|หายไว|สดชื่น/,
  elderly:  /สุข|แข็งแรง|ห่วงใย|อายุ|สบาย|รัก/,
};

// ── คำขึ้นต้นการ์ด (headline) แยกตามหมวด ────────────────────────────────────
// คำหัวหมวดเป็น "บรรทัดพิเศษ" ที่ขึ้นเหนือบรรทัด "สวัสดีวัน..." (ทุกการ์ดมีสวัสดีวันเสมอ)
// (เช่น วันเกิด → "สุขสันต์วันเกิด" + "สวัสดีวันพุธ") — AI คิดใหม่ทุกวัน, มี fallback สำรอง
...
async function genCatHeadlines() {
  ...
  const prompt =
    ...
    + `- ต้องเป็นภาษาไทยธรรมชาติ เรียงคำถูกต้องแบบที่คนไทยพูดจริง ห้ามแปลตรงจากภาษาอังกฤษ\n`
    + `- ห้ามขึ้นต้นด้วยคำว่า "แด่" "แก่" "ถึง" "สำหรับ" "เพื่อ" (เช่น "แด่คนวันเกิด" = เรียงประโยคผิด ห้ามใช้)\n`
    ...
    try {
      ...
      if (m) {
        ...
        for (const c of CAT_GREETING_CATS) {
          // กรองเข้ม: รูปประโยคไทยถูกต้อง + มี keyword ของหมวดจริง (กัน "แด่คนวันเกิด" หลุด)
          const kw = CAT_HEADLINE_KEYWORDS[c];
          const arr = Array.isArray(obj[c])
            ? obj[c].filter(x => typeof x === 'string').map(x => x.trim())
                .filter(x => validCardText(x, { min: 2, max: 24 }) && (!kw || kw.test(x)))
            : [];
...
// ── หมวดหมู่ (tab หมวด = filter ของรูป "วันนี้" — ทุกการ์ดมี "สวัสดีวัน..." เสมอ) ──
...
// หมวดเชิงความรู้สึก (miss/family/elderly) ภาพต้องสื่ออารมณ์/มีคน → ใช้ AI gen อย่างเดียว
...
// → tab หมวดกรองจาก manifest.categories ของวันนี้ ; โฟลเดอร์ img/cat_bank เก่าถูก prune ทิ้งอัตโนมัติ
...
async function main() {
  ...
  // ── กติกา headline (มิ.ย.2569 — ตามเจ้าของ): ทุกการ์ดมี "สวัสดีวัน..." เป็นพื้นฐานเสมอ
  // บรรทัดพิเศษ (วันพระ/วันสำคัญ/คำหัวหมวด) ขึ้น "เหนือ" บรรทัดสวัสดีวัน เฉพาะการ์ดที่ภาพตรงธีม
  // รูปแบบเก็บ: "บรรทัดพิเศษ\nสวัสดีวัน..." — buildCard ฝั่ง render แยกบรรทัดให้เอง
  const helloLine = `สวัสดีวัน${dayTheme.th}`;
  // ชื่อวันสำคัญที่ขึ้นต้นด้วย "วัน" เติม "วันนี้" ข้างหน้า (เช่น "วันนี้วันปิยมหาราช")
  const festLine = fest ? (fest.headline.startsWith('วัน') ? 'วันนี้' + fest.headline : fest.headline) : null;
  const headline = helloLine;  // ค่า default ของ manifest (การ์ดทั่วไป)
  ...
  // พรยาวแบบ "พรผู้ใหญ่" (curated) เติมเข้าคลังวันเสมอ — มีให้ใช้แม้วัน AI gen ล้ม (เช็คซ้ำ = idempotent ข้ามรอบ)
  const LONG_BLESSINGS = [
    'ขอบุญบารมีคุ้มครองปกป้อง พบแต่สิ่งที่ดีๆ มั่งมีศรีสุข เจริญรุ่งเรือง สำเร็จสมปรารถนา สุขภาพแข็งแรง',
    'รวยสุข รวยทรัพย์ รวยความดี มั่งคั่ง มั่งมี สุขภาพแข็งแรง ครอบครัวอบอุ่นเป็นสุข',
    'ขอสิ่งศักดิ์สิทธิ์คุ้มครอง ให้แคล้วคลาดปลอดภัย โชคลาภเงินทองไหลมาเทมา คิดสิ่งใดสมปรารถนา',
    'ขอให้สุขภาพแข็งแรง อายุมั่นขวัญยืน ลูกหลานกตัญญู อยู่เย็นเป็นสุขตลอดไป',
  ...
  const WAN_PHRA_BLESSINGS = ['วันพระนี้ ขอให้อิ่มบุญอิ่มใจ', 'ใส่บาตรวันพระ ขอให้ชีวิตร่มเย็นเป็นสุข',
    'ทำบุญวันพระ ขอให้สมหวังดั่งตั้งใจ', 'วันพระนี้ ขอให้จิตใจผ่องใส เปี่ยมบุญกุศล'];
  const themedBlPool = fest ? (fest.blessings || [])
    : (wanPhra ? [...WAN_PHRA_BLESSINGS, ...DHAMMA_PROVERBS.map(p => p.th)] : []);
  const pickThemedBl = () => themedBlPool.length
    ? themedBlPool[Math.floor(Math.random() * themedBlPool.length)]
    : pickBl(st.images.length);
  ...
  const catHeadlineFor = (cat, i) => {
    if (!cat) return null;
    // validate ซ้ำตอนใช้ — กันคำเพี้ยนที่ค้างใน manifest ซึ่ง gen ไว้ก่อนตัวกรองนี้ (เช่น "แด่คนวันเกิด")
    const kw = CAT_HEADLINE_KEYWORDS[cat];
    let pool = ((st.catHeadlines && st.catHeadlines[cat]) || []).filter(x => validCardText(x, { min: 2, max: 24 }) && (!kw || kw.test(x)));
    if (!pool.length) pool = CAT_GREETING_FALLBACK[cat] || [];
  ...
  while (st.images.length < TARGET && timeLeft() > 90000 && gens < MAX_GEN_PER_RUN) {
    ...
    try {
      // หมวดดอกไม้: ผสม query ดอกไม้สีประจำวัน — ผู้สูงอายุจำสีวันแม่น ภาพตรงสีวัน = ถูกใจ/ส่งต่อ
      ...
      const tryGen = async () => {
        // หมวดดอกไม้: ครึ่งหนึ่ง gen เป็นดอกไม้สีประจำวันตรงๆ (เข้าคู่กับ query รูปถ่ายด้านบน)
    ...
    // หมวดสุดท้ายของรูปนี้ (gen เจาะหมวด = รู้แน่ ; อื่น ๆ เดาจาก subject/แหล่งรูป)
    const imgCat = cat || guessCategory(subject, src);

    // headline ต่อใบ — ทุกใบมี "สวัสดีวัน..." เสมอ ; บรรทัดพิเศษเฉพาะใบที่ภาพตรงธีม
    // วันรำลึก (solemn): ใบ tribute ใช้คำรำลึกอย่างเดียว ไม่ขึ้น "สวัสดี" (ใบทั่วไปขึ้นสวัสดีปกติ)
    let cardHeadline;
    if (themed && fest) cardHeadline = fest.solemn ? festLine : `${festLine}\n${helloLine}`;
    else if (themed && wanPhra) cardHeadline = `วันนี้วันพระ\n${helloLine}`;
    else {
      const catHl = (fest || wanPhra) ? null : catHeadlineFor(imgCat, st.images.length);
      cardHeadline = catHl ? `${catHl}\n${helloLine}` : helloLine;
    }

    // blessing ต่อใบ — ใบธีมพิเศษใช้คำของวันนั้น, ใบมีหมวดใช้คำหมวด (curated), ที่เหลือใช้คลังวัน
    let blessing;
    if (themed) blessing = pickThemedBl();
  ...
  // 3) เติม evergreen fallback (เฉพาะตอน deck รายวันเต็มแล้วเท่านั้น — ลำดับท้ายสุด)
  // (ระบบ cat_bank ถูกถอดออกแล้ว — tab หมวดใช้รูปของวันนี้จาก manifest.categories)
  {
