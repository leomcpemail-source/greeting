...
- สร้างโฟลเดอร์ `refs/` ในรีโป — เจ้าของหย่อนภาพสวัสดีที่เห็นคนส่งต่อกันจริงใน LINE (20–50 ใบ พอเริ่ม
  เติม/ลบได้ตลอด = พวงมาลัยคุมทิศทางของเจ้าของ)
- ทุก run: ถ้า refs เปลี่ยน → CLIP (ติดตั้งแล้ว) แปลงเป็น embedding เก็บ `output/ref-embeds.json`
  (คิดครั้งเดียวต่อภาพ ไม่เปลือง)
...
- ข้อกฎหมาย: ภาพ refs ใช้คำนวณสถิติภายในเท่านั้น ไม่ถูกเผยแพร่/ทำซ้ำในผลงาน — ปลอดภัยกว่า scrape เน็ตมาก
  (ถ้าไม่อยากให้ภาพอยู่ในรีโปสาธารณะ: เก็บเฉพาะ embedding แล้วลบภาพได้)
